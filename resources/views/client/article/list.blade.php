...
<div class="article">
    <div class="text-center fs-75" style="font-family: 'Lobster', cursive;">List Article</div>
                        ...
                        @foreach($list_obj as $item)
                            <li class="clearfix ">
                                ...
                                <div class="blog-item-title ml-2">
                                    ...
                                    <a href="#">
                                        <h4 style="color: #5a6268; font-size: 0.8em; text-transform: capitalize;">By
                                            : {{$item->author}}</h4>
                                    </a>
                                    <p>
                                    ...
                                    <div class="blog-content-short-description more"
                                         style="font-family: 'Montserrat Alternates', sans-serif;">{{$item->content}}</div>
                                </div>
                            </li>
                            <hr/>
                        @endforeach
